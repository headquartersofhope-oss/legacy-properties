        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <div 
              ...
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-blue-400 transition-all cursor-pointer group"
            >
            ...
            <div 
              ...
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-purple-400 transition-all cursor-pointer group"
            >
            ...
            <div 
              onClick={() => handleNavigate('/beds', { status: 'available' })}
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-green-400 transition-all cursor-pointer group"
            >
            ...
            <div 
              onClick={() => handleNavigate('/occupancy', {})}
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-orange-400 transition-all cursor-pointer group"
            >
          ...
          {/* Operations Grid - Interactive */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <div 
              onClick={() => handleNavigate('/properties', { occupancy_level: 'full' })}
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-red-400 transition-all cursor-pointer group"
            >
              <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1">
                <AlertCircle className="w-3 h-3" /> At Capacity
              </div>
            ...
            <div 
              onClick={() => handleNavigate('/properties', { occupancy_level: 'near' })}
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-amber-400 transition-all cursor-pointer group"
            >
              <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1">
            ...
            <div 
              onClick={() => handleNavigate('/referrals', { status: 'under_review' })}
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-sky-400 transition-all cursor-pointer group"
            >
              <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1">
            ...
            <div 
              ...
              className="bg-card border-2 border-border rounded-lg p-4 shadow-sm hover:shadow-lg hover:border-emerald-400 transition-all cursor-pointer group"
            >
              <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1">
                <CheckCircle className="w-3 h-3" /> System Health
              </div>
              <div className="text-2xl font-bold text-emerald-600 group-hover:text-emerald-700 transition-colors">Good</div>
              <div className="text-[10px] text-muted-foreground mt-2">All operational</div>
            </div>
          </div>

          {/* Housing Model Split - Interactive */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div 
              onClick={() => handleNavigate('/properties', { housing_model: 'per_bed' })}
              className="bg-card rounded-lg border-2 border-indigo-200 bg-indigo-50 p-6 shadow-sm hover:shadow-lg hover:border-indigo-400 transition-all cursor-pointer group"
            >
              ...
              <div className="text-sm text-muted-foreground">
                {perBedProps.reduce((sum, p) => sum + (p.total_bed_count || 0), 0)} beds available
              </div>
            </div>

            <div 
              onClick={() => handleNavigate('/properties', { housing_model: 'turnkey_house' })}
              className="bg-card rounded-lg border-2 border-amber-200 bg-amber-50 p-6 shadow-sm hover:shadow-lg hover:border-amber-400 transition-all cursor-pointer group"
            >
              <div className="flex items-center gap-2 mb-2">
